...
#    script will create directory/fragments.concat and copy it to the final
#    destination.   Execution happens only when:
...
#  - Defines a File resource to ensure $mode is set correctly but also to
#    provide another means of requiring
#
# ALIASES:
